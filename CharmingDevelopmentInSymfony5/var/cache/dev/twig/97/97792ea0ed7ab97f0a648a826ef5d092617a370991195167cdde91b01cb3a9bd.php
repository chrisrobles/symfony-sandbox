...
class __TwigTemplate_d91322c728f9a6db814e9d3c89337e2c62e7d803d374c3a6fbba8848a7b9aa5d extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"container\">
        ...
        // line 29
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_cauldron_overflow_question", ["question" => "reversing-a-spell"]);
        ...
        echo "\" width=\"100\" height=\"100\">
                        ...
                        <div class=\"col\">
                            <a class=\"q-title\" href=\"";
        // line 57
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_cauldron_overflow_question", ["question" => "pausing-a-spell"]);
                ...
                <div style=\"box-shadow: 2px 3px 9px 4px rgba(0,0,0,0.04);\">
                    <div class=\"q-container p-4\">
                        <div class=\"row\">
                            ...
                            <div class=\"col\">
                                <a class=\"q-title\" href=\"{{ path('app_cauldron_overflow_question', {question: 'reversing-a-spell'}) }}\"><h2>Reversing a Spell</h2></a>
                                <div class=\"q-display p-3\">
                                    <i class=\"fa fa-quote-left mr-3\"></i>
                                    <p class=\"d-inline\">I've been turned into a cat, any thoughts on how to turn back? While I'm adorable, I don't really care for cat food.</p>
                                    <p class=\"pt-4\"><strong>--Tisha</strong></p>
                    ...
                    <a class=\"answer-link\" href=\"{{ path('app_cauldron_overflow_question', {question: 'reversing-a-spell'}) }}\" style=\"color: #fff;\">
                        <p class=\"q-display-response text-center p-3\">
                            <i class=\"fa fa-magic magic-wand\"></i> 6 answers
                        </p>
                    </a>
            ...
            <div class=\"col-12 mt-3\">
                <div class=\"q-container p-4\">
                    <div class=\"row\">
                        ...
                        <div class=\"col\">
                            <a class=\"q-title\" href=\"{{ path('app_cauldron_overflow_question', {question: 'pausing-a-spell'}) }}\"><h2>Pausing a Spell</h2></a>
                            <div class=\"q-display p-3\">
                                <i class=\"fa fa-quote-left mr-3\"></i>
                                <p class=\"d-inline\">I mastered the floating card, but now how do I get it back to the ground?</p>
                                <p class=\"pt-4\"><strong>--Jerry</strong></p>
                ...
                <a class=\"answer-link\" href=\"{{ path('app_cauldron_overflow_question', {question: 'pausing-a-spell'}) }}\" style=\"color: #fff;\">
                    <p class=\"q-display-response text-center p-3\">
                        <i class=\"fa fa-magic magic-wand\"></i> 15 answers
                    </p>
                </a>
...
{% endblock %}
", "question/homepage.html.twig", "/home/christian/Downloads/current/symfony-sandbox/templates/question/homepage.html.twig");
    }
}
